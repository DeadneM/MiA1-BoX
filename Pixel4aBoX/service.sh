...
# # # SCHEDUTIL FREQ # # #
echo '1248000' > /sys/devices/system/cpu/cpufreq/policy0/schedutil/highspeedfreq && chmod 0444 /sys/devices/system/cpu/cpufreq/policy0/schedutil/highspeedfreq
echo '1555200' > /sys/devices/system/cpu/cpufreq/policy6/schedutil/highspeedfreq && chmod 0444 /sys/devices/system/cpu/cpufreq/policy6/schedutil/highspeedfreq
# # # SCHEDTUNE # # #
#general
