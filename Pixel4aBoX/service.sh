...
echo '0-5' > /dev/cpuset/background/cpus; chmod 0444 /dev/cpuset/background/cpus
#foreground
...
echo '0-7' > /dev/cpuset/top-app/cpus; chmod 0444 /dev/cpuset/top-app/cpus
#camera-daemon
...
#restricted
echo '0-5' > /dev/cpuset/restricted/cpus; chmod 0444 /dev/cpuset/restricted/cpus
#system background
echo '0-5' > /dev/cpuset/system-background/cpus; chmod 0444 /dev/cpuset/system-background/cpus
